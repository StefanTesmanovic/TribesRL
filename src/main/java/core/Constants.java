...
public class Constants {
    ...
    public static boolean TURN_TIME_LIMITED = true; // if true, agents have a limited amount of time to finish their turn, which is specified by TURN_TIME_MILLIS

    public static long TURN_TIME_MILLIS = 5000; //10000; //5 seconds.
    ...
    public static int MAX_TURNS_CAPITALS = 500; //Integer.MAX_VALUE; //Setting a max is useful for experiments
